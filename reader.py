...
def loadAllFeedsFromFile(path = "data", limitsize=None ): #this is probably a stupid place for the data long term
    ...
    ret = allDict
    if bool(limitsize): ret = smallDict(allDict,limitsize) # use test values
    collateDocContents(ret)
    return ret
